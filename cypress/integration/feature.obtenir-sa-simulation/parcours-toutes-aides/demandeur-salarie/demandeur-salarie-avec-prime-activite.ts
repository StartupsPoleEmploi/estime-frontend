...
describe(specTitleSimulationDeSalarie('FEATURE - Obtenir ma simulation - Demandeurs d\'emploi salarié'), () => {
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'salarié qui cumule ancien et nouveau salaire', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-salarie/demandeur-avec-prime-activite/avec-cumul-des-salaires.json' })
      ...
      const montantPrimeActiviteAvantSimulation = "500";
      ...
      ressourcesActuellesPage.saisirMontantPrimeActivite(montantPrimeActiviteAvantSimulation);
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.PRIME_ACTIVITE, 1, montantPrimeActiviteAvantSimulation);
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.PRIME_ACTIVITE, 2, montantPrimeActiviteAvantSimulation);
      resultatMaSimulationPage.clickOnRetour();
      //troisième mois
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.PRIME_ACTIVITE, 3, montantPrimeActiviteAvantSimulation);
      resultatMaSimulationPage.clickOnRetour();
      //quatrième mois
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'salarié qui ne cumule pas ancien et nouveau salaire', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-salarie/demandeur-avec-prime-activite/sans-cumul-des-salaires.json' })
