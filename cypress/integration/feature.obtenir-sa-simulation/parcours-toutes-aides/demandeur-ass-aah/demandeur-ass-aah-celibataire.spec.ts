...
describe(specTitleSimulationDeASSEtAAH('FEATURE - Obtenir ma simulation - Demandeurs d\'emploi ASS et AAH'), () => {
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    ' je souhaite obtenir ma simulation', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-ass-aah/test1-0-enfant-proprietaire-travaille-5-mois-dans-6-derniers-mois-2-mois-dans-3-derniers-mois.json' })
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    ' je souhaite obtenir ma simulation', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-ass-aah/test2-0-enfant-locataire-travaille-4-mois-dans-6-derniers-mois-1-mois-dans-3-derniers-mois.json' })
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    ' je souhaite obtenir ma simulation', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-ass-aah/test3-1-enfant-locataire-travaille-3-mois-dans-6-derniers-mois-3-mois-dans-3-derniers-mois.json' })
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    ' je souhaite obtenir ma simulation', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-ass-aah/test4-2-enfants-locataire-travaille-3-mois-dans-6-derniers-mois-0-mois-dans-3-derniers-mois.json' })
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'je souhaite obtenir ma simulation', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-ass-aah/test5-2-enfants-proprietaire-travaille-3-mois-dans-6-derniers-mois-0-mois-dans-3-derniers-mois.json' })
