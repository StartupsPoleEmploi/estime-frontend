...
describe(specTitleSimulationDeRSA('FEATURE - Obtenir ma simulation - Demandeurs d\'emploi RSA'), () => {
  ...
  it('demandeur célibataire, seul deuis plus de 18 mois, non propriétaire, sans enfant,' +
    ...
    'domicile->travail 10kms / 20 trajets', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-rsa/demandeur-rsa-prochaine-declaration-mois0/test1-celibataire-locataire-travaille-0-mois.json' })
  ...
  it('demandeur en couple, non propriétaire, 0 enfant,' +
    ...
    'domicile->travail 10kms / 20 trajets', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-rsa/demandeur-rsa-prochaine-declaration-mois0/test2-en-couple-locataire-travaille-0-mois.json' })
  ...
  it('demandeur célibataire, seul deuis plus de 18 mois, non propriétaire, sans enfant,' +
    ...
    'domicile->travail 10kms / 20 trajets', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-rsa/demandeur-rsa-prochaine-declaration-mois0/test3-celibataire-locataire-travaille-1-mois.json' })
  ...
  it('demandeur célibataire, seul deuis plus de 18 mois, non propriétaire, sans enfant,' +
    ...
    'domicile->travail 10kms / 20 trajets', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-rsa/demandeur-rsa-prochaine-declaration-mois0/test4-celibataire-locataire-travaille-3-mois.json' })
  ...
  it('demandeur célibataire, seul depuis plus de 18 mois, sans enfant, ' +
    ...
    'proprietaire', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-rsa/demandeur-rsa-prochaine-declaration-mois0/test5-celibataire-proprietaire-travaille-3-mois.json' })
