...
describe(specTitleSimulationDeMicro('FEATURE - Obtenir ma simulation - Demandeurs d\'emploi Micro entrepreneur - entreprise créée année N-2'), () => {
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'micro entreprise (Achat / revente) - créée il y a 2 ans', () => {

      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-micro/demandeur-micro-date-creation-n-moins-2/ar.json' })
      ...
      const dateRepriseCreationEntreprise = dateUtileTests.getDateRepriseCreationEntrepriseDepuisXMois(28);
      ...
      const montantChiffreAffairesNMoins2 = "1000";
      ...
      ressourcesActuellesPage.saisirCAMicroEntrepriseNMoins2(montantChiffreAffairesNMoins2);
      ressourcesActuellesPage.saisirCAMicroEntrepriseNMoins1(montantChiffreAffairesNMoins1);
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'futur contrat CDI, salaire 940€ net, 35h/semaine,' +
    'kilométrage domicile -> taf = 80kms + 12 trajets' +
    'micro entreprise (bic) - créée il y a 2 ans', () => {

      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-micro/demandeur-micro-date-creation-n-moins-2/bic.json' })
      ...
      const montantAideMobilite = "192";
      const montantAgepi = "400";
      const montantPrimeActiviteM2_M3_M4 = "51";
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'futur contrat CDI, salaire 940€ net, 35h/semaine,' +
    'kilométrage domicile -> taf = 80kms + 12 trajets' +
    'micro entreprise (bnc) - créée il y a 2 ans', () => {

      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-micro/demandeur-micro-date-creation-n-moins-2/bnc.json' })
