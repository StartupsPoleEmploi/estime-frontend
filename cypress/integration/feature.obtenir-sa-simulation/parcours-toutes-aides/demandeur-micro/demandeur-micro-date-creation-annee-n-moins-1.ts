...
describe(specTitleSimulationDeMicro('FEATURE - Obtenir ma simulation - Demandeurs d\'emploi Micro entrepreneur - entreprise créée année N-1'), () => {
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'micro entreprise (Achat / revente) - créée il y a 1 ans', () => {

      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-micro/demandeur-micro-date-creation-n-moins-1/ar.json' })
      ...
      const dateRepriseCreationEntreprise = dateUtileTests.getDateRepriseCreationEntrepriseDepuisXMois(14);
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'futur contrat CDI, salaire 940€ net, 35h/semaine,' +
    'kilométrage domicile -> taf = 80kms + 12 trajets' +
    'micro entreprise (bic) - créée il y a 1 ans', () => {

      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-micro/demandeur-micro-date-creation-n-moins-1/bic.json' })
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'futur contrat CDI, salaire 940€ net, 35h/semaine,' +
    'kilométrage domicile -> taf = 80kms + 12 trajets' +
    'micro entreprise (bnc) - créée il y a 1 ans', () => {

      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-micro/demandeur-micro-date-creation-n-moins-1/bnc.json' })
