...
describe(specTitleSimulationDeAAH('FEATURE - Obtenir ma simulation - Demandeurs d\'emploi AAH - 3 mois travaillé avant simulation'), () => {
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'kilométrage domicile -> taf = 80kms + 12 trajets', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-aah/demandeur-aah-3-mois-travaille-avant-simulation/sans-logement.json' })
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'locataire (loyer : 500, charges 50)', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-aah/demandeur-aah-3-mois-travaille-avant-simulation/avec-logement.json' })
