...
describe(specTitleSimulationDeAAH('FEATURE - Obtenir ma simulation - Demandeurs d\'emploi AAH - 1 mois travaillé avant simulation'), () => {
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'kilométrage domicile -> taf = 80kms + 12 trajets', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-aah/demandeur-aah-1-mois-travaille-avant-simulation/sans-logement.json' })
      ...
      const montantPrimeActiviteM2_M3 = "58";
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.ALLOCATION_ADULTES_HANDICAPES, 1, montantAAH_M1_M2_M3_M4_M5);
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.ALLOCATION_ADULTES_HANDICAPES, 2, montantAAH_M1_M2_M3_M4_M5);
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.ALLOCATION_ADULTES_HANDICAPES, 3, montantAAH_M1_M2_M3_M4_M5);
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.ALLOCATION_ADULTES_HANDICAPES, 4, montantAAH_M1_M2_M3_M4_M5);
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.ALLOCATION_ADULTES_HANDICAPES, 5, montantAAH_M1_M2_M3_M4_M5);
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.ALLOCATION_ADULTES_HANDICAPES, 6, montantAAH_M6);
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'locataire (loyer : 500, charges 50)', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/parcours-toutes-aides/demandeur-aah/demandeur-aah-1-mois-travaille-avant-simulation/avec-logement.json' })
