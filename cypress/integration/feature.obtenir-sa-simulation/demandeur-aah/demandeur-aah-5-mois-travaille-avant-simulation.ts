...
describe(specTitleSimulationDeAAH('FEATURE - Obtenir ma simulation - Demandeurs d\'emploi AAH - 5 mois travaillé avant simulation'), () => {
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'kilométrage domicile -> taf = 80kms + 12 trajets', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/demandeur-aah/demandeur-aah-5-mois-travaille-avant-simulation/sans-logement.json' })
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'locataire (loyer : 500, charges 50)', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/demandeur-aah/demandeur-aah-5-mois-travaille-avant-simulation/avec-logement.json' })
