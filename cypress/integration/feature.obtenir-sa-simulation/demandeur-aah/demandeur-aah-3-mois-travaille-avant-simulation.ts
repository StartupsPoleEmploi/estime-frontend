...
describe(specTitleSimulationDeASS('FEATURE - Obtenir ma simulation - Demandeurs d\'emploi AAH - 3 mois travaillé avant simulation'), () => {
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'montant AAH 900€, ' +
    '3 mois travaillé avant simulation dont 2 mois dans les 3 derniers mois avant la simulation, ' +
    'futur contrat CDI, salaire 940€ net, 35h/semaine,' +
    'kilométrage domicile -> taf = 80kms + 12 trajets', () => {

      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/demandeur-aah/demandeur-aah-3-mois-travaille-avant-simulation/sans-logement.json' })
      ...
      const montantAAH_M1_M2_M3 = "900";
      const montantAAH_M4_M5_M6 = "171";
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.ALLOCATION_ADULTES_HANDICAPES, 1, montantAAH_M1_M2_M3);
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.ALLOCATION_ADULTES_HANDICAPES, 2, montantAAH_M1_M2_M3);
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.ALLOCATION_ADULTES_HANDICAPES, 3, montantAAH_M1_M2_M3);
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.ALLOCATION_ADULTES_HANDICAPES, 4, montantAAH_M4_M5_M6);
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.ALLOCATION_ADULTES_HANDICAPES, 5, montantAAH_M4_M5_M6);
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.ALLOCATION_ADULTES_HANDICAPES, 6, montantAAH_M4_M5_M6);
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'locataire (loyer : 500, charges 50)', () => {
      ...
      cy.intercept('POST', '**/simulation_aides', { fixture: 'mocks/demandeur-aah/demandeur-aah-3-mois-travaille-avant-simulation/avec-logement.json' })
