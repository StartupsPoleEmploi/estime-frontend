...
describe(specTitleSimulationDeASS('FEATURE - Obtenir ma simulation - Demandeurs d\'emploi AAH - 3 mois travaillé avant simulation'), () => {
  ...
  it('En tant que demandeur emploi célibataire,' +
    ...
    'kilométrage domicile -> taf = 80kms + 12 trajets', () => {
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.ALLOCATION_ADULTES_HANDICAPES, montantAAH_M1_M2_M3);
      ...
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesRessourcesFinancieresEnum.PAIE, salaireNet);
      resultatMaSimulationPage.checkMontantRessourceFinanciere(CodesAidesEnum.ALLOCATION_ADULTES_HANDICAPES, montantAAH_M4_M5_M6);
