...
describe(specTitleSimulationDeASS('FEATURE - Obtenir ma simulation - Demandeurs d\'emploi ASS avec APL'), () => {
  ...
  it('Demandeur emploi célibataire, sans enfant,' +
     'CDI 20h, salaire 1150 €, ASS 16.49 €, APL 120€' +
