export enum LiensUtilesEnum {
    DESCRIPTION_AGEPI = 'https://plmpl.fr/c/KAb2D',
    DESCRIPTION_AIDE_MOBILITE = 'https://plmpl.fr/c/am5Qt',
    DESCRIPTION_PRIME_ACTIVITE = 'https://www.caf.fr/allocataires/aides-et-demarches/droits-et-prestations/vie-professionnelle/la-prime-d-activite#:~:text=Pour avoir droit à la,cours des trois derniers mois',
    ...
    DESCRIPTION_ASS = 'https://plmpl.fr/c/61vmU',
