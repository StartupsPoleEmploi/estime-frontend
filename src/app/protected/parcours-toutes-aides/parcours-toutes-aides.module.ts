...
import { ContratTravailComponent } from '@app/protected/parcours-toutes-aides/1.contrat-travail/contrat-travail.component';
import { MaSituationComponent } from '@app/protected/parcours-toutes-aides/2.ma-situation/ma-situation.component';
import { MesPersonnesAChargeComponent } from '@app/protected/parcours-toutes-aides/3.mes-personnes-a-charge/mes-personnes-a-charge.component';
...
import { RessourcesActuellesComponent } from '@app/protected/parcours-toutes-aides/4.ressources-actuelles/ressources-actuelles.component';
...
import { RessourcesFinancieresFoyerComponent } from '@app/protected/parcours-toutes-aides/4.ressources-actuelles/ressources-financieres-foyer/ressources-financieres-foyer.component';
import { RessourcesFinancieresPersonnesAChargeComponent } from '@app/protected/parcours-toutes-aides/4.ressources-actuelles/ressources-financieres-personnes-a-charge/ressources-financieres-personnes-a-charge.component';
import { VosRessourcesFinancieresComponent } from '@app/protected/parcours-toutes-aides/4.ressources-actuelles/vos-ressources-financieres/vos-ressources-financieres.component';
import { ResultatSimulationComponent } from '@app/protected/parcours-toutes-aides/5.resultat-simulation/resultat-simulation.component';
