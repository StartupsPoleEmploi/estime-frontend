...
export class TemoignageService {
  ...
  private initTemoignages(): void {
    ...
    temoignage1.temoignage = '"C\'est très bien de savoir qu\'on ne va pas perdre, j\'avais très peur de perdre des aides et de ne pas y arriver."';
    temoignage1.auteur = "Ibanez"
    this.temoignages.push(temoignage1);

    const temoignage2 = new Temoignage();
    temoignage2.temoignage = '"Je recommande. C\'est une bonne idée et un bon site. Il suffit de lire et c\'est compréhensif par tous."';
    temoignage2.auteur = "Cynthia"
    this.temoignages.push(temoignage2);

    const temoignage3 = new Temoignage();
    temoignage3.temoignage = '"C\'est vraiement du pas à pas, facile à comprendre et à faire"';
